  ...
  return createPortal(
    <div className="absolute top-0 left-0 z-20 h-full w-full bg-white/5 p-4 font-mono backdrop-blur-md transition-all">
      <div
        ...
        className="text-md absolute top-1/2 left-1/2 flex h-fit w-2xl -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-lg bg-[#1c1b22] px-4 pt-8 pb-4 shadow-2xs shadow-black"
      >
        <button
